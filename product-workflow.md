...
| Step | Name | Sub-agent? | Persona | BMAD Knowledge (max 2 files) |
|------|------|:----------:|---------|-------------------------------|
| 1 | Idea Capture | ✅ | analyst | `1-analysis/bmad-agent-analyst/customize.toml`<br>`1-analysis/bmad-product-brief/assets/brief-template.md` |
| 2 | Problem Validation | ✅ | analyst | `1-analysis/bmad-agent-analyst/customize.toml`<br>`1-analysis/research/bmad-market-research/steps/step-03-customer-pain-points.md` |
| 3 | Research & Validation | ✅ | analyst | `1-analysis/research/bmad-market-research/SKILL.md`<br>`1-analysis/research/bmad-market-research/steps/step-05-competitive-analysis.md` |
| 4 | Run Initialization | ❌ orchestrator | — | _(none)_ |
| 5 | Product Vision & Roadmap | ✅ | pm | `2-plan-workflows/bmad-agent-pm/customize.toml`<br>`2-plan-workflows/bmad-create-prd/SKILL.md` |
| 5R | Roadmap Review | ✅ | product-strategist | `2-plan-workflows/bmad-validate-prd/SKILL.md`<br>`2-plan-workflows/bmad-prd/assets/prd-validation-checklist.md` |
| 6 | System Architecture | ✅ | architect | `3-solutioning/bmad-agent-architect/customize.toml`<br>`3-solutioning/bmad-create-architecture/SKILL.md` |
| 6R | Architecture Review | ✅ | system-architect | `3-solutioning/bmad-create-architecture/steps/step-07-validation.md` |
| 7 | Decision Log | ❌ orchestrator | — | _(none)_ |
...
| Step | Name | Sub-agent? | Persona | BMAD Knowledge (max 2 files) |
|------|------|:----------:|---------|-------------------------------|
| 1 | Select Version Scope | ❌ orchestrator | — | _(none)_ |
| 2 | Requirement Contract | ✅ | pm | `2-plan-workflows/bmad-agent-pm/customize.toml`<br>`2-plan-workflows/bmad-prd/SKILL.md` |
| 3 | Priority Ranking | ✅ | pm | `2-plan-workflows/bmad-agent-pm/customize.toml` |
| 4 | PRD Authoring | ✅ | pm | `2-plan-workflows/bmad-prd/SKILL.md`<br>`2-plan-workflows/bmad-prd/assets/prd-template.md` |
| 5 | PRD Review | ✅ | product-planner | `2-plan-workflows/bmad-validate-prd/SKILL.md`<br>`2-plan-workflows/bmad-prd/assets/prd-validation-checklist.md` |
| 6 | UI Design Brief | ✅ | ux-designer | `2-plan-workflows/bmad-agent-ux-designer/customize.toml`<br>`2-plan-workflows/bmad-ux/SKILL.md` |
| 6R | UI Brief Review | ✅ | ux-reviewer | `2-plan-workflows/bmad-ux/references/validate.md` |
| 7 | Analyze Gate | ✅ | qa | `3-solutioning/bmad-check-implementation-readiness/SKILL.md` |
| 8 | Build Handoff | ✅ | pm | `3-solutioning/bmad-create-epics-and-stories/SKILL.md` |
| 9 | Readiness Check | ❌ orchestrator | — | _(none)_ |
...
| BMAD Knowledge | Files from BMAD-METHOD repo (`src/bmm-skills/` prefix). Max 2 per step. |
...
| Step | Input | Output |
|------|-------|--------|
| 1 Select Scope | `docs/product/<project>-roadmap.md` | _(confirmed version name — stored in run-manifest)_ |
| 2 Requirements | `docs/product/<project>-roadmap.md` § target version | `docs/prd/<feature>-requirements.md` |
